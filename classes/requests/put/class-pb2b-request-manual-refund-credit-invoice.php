 ...
 * Credit order request class.
 */
class PB2B_Request_Manual_Refund_Credit_Invoice extends PB2B_Request {
	/**
	 * Makes the request.
	 *
	...
	public function get_body( $order_id, $amount, $reason ) {
		...
		return array(
			'items'         => PB2B_Credit_Data::get_partial_refund_items( $order_id )['manual_refund_data'],
